...
class eventModelDb
{
    public static function getEventById($id)
    {
        ...
        $sql = "SELECT
                    Event_id,category_id,city_id,event_name_$lang as event_name,event_phone,
                event_time,address_$lang as address,meta_keyword,meta_description,
                logo,brief_description_$lang as brief_description,description_$lang as description,`date`,priority,status,lat,`longe`,price
                FROM
                    event
                WHERE
    ...
    public function getEvent($fields = '')
    {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS 
                ...
                Event_id,category_id,city_id,event_name_$lang as event_name,event_phone,
                event_time,address_$lang as address,meta_keyword,meta_description,
                logo,brief_description_$lang as brief_description,description_$lang as description,`date`,priority,status
