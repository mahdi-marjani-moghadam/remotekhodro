...
class adminContactusController
{
    ...
    {
        $contactus = adminContactusModel::getAll()->getList();
        if($contactus['result']!='1')
        {
            $this->fileName='admin.contactus.showList.php';
            $this->template('',$contactus['msg']);
            die();
        }

        $export['list']=$contactus['export']['list'];

        $export['recordsCount']=$contactus['export']['recordsCount'];
        $this->fileName='admin.contactus.showList.php';
