...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> ویرایش شرایط فروش</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-tablesorter" class="panel panel-warning">
    <div class="panel-heading bg-white">
      <h3 class="panel-title rtl">جزییات شرایط فروش</h3>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                    <input type="text" class="form-control" name="title" id="title"   value="<?=$list['list']['title']?>">
                  </div>
                </div>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                    <input type="text" class="form-control" name="brief_description" id="brief_description"  value="<?=$list['list']['brief_description']?>">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                    <textarea  class="form-control" name="description" id="description" ><?=$list['list']['description']?></textarea>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                    ...
                    <img class="img-thumbnail" src="<?=RELA_DIR?>statics/sales/<?=$list['list']['image']?>">
                  </div>
                </div>
              </div>
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 pull-right">
                            <select name="category_id" id="category_id" data-input="select2" multiple>
                                ...
                                {
                                    ?>
                                    <option onclick="id" <?php echo in_array($value['Category_id'], $list['category_id']) ? 'selected' : '' ?>
                ...
                <p class="pull-right">
                  <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                    <input name="action" type="hidden" id="action" value="edit" />
                      <input type="hidden" name="parent_id" id="parent_id"value="<?= $value['category']['parent_id'] ?>"
                    <input name="Sales_id" type="hidden" id="" value="<?=$list['Sales_id']?>" />
