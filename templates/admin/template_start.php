...
<head>
    ...
    <link rel="stylesheet" href="<?php echo RELA_DIR; ?>templates/<?php echo CURRENT_SKIN; ?>/assets/css/hover-min.css">
    <!-- endbower -->
    <!-- endbuild -->
    ...
    <link id="style-sample" href="<?php echo RELA_DIR; ?>templates/<?php echo CURRENT_SKIN; ?>/assets/css/bootstrap-tagsinput.css" rel="stylesheet">
    <!-- endbuild -->
