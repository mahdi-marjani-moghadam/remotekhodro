      ...
      <div class="panel-body">
        ...
        <p class="lead"></p><!--/lead as title-->
          ...
          <ul class="list-percentages row ">
            ...
            <li class="col-xs-12">
              <p class="text-ellipsis">درخواست های ارسالی خرید </p>
              <p class="text-lg"><strong><?php echo $list['cv_count'];?></strong></p>
            </li>
    ...
    <div id="overall-visitor" class="panel panel-animated panel-success bg-success">
      <div class="panel-body">
        ...
        <ul class="list-percentages row ">
          ...
          <li class="col-xs-12">
            <p class="text-ellipsis">تعداد کل پست های بلاگ</p>
            <p class="text-lg"><strong><?php echo $list['blog_count'];?></strong></p>
          </li>
  ...
  <div class="col-md-3">
    <div id="overall-visitor" class="panel panel-animated panel-danger bg-danger">
      <div class="panel-body">
        ...
        <ul class="list-percentages row ">
          <li class="col-xs-12">
            <p class="text-ellipsis">تعداد کل خدمات</p>
            <p class="text-lg"><strong><?php echo $list['sales_count'];?></strong></p>
          </li>
