                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" enctype="multipart/form-data" class="form-horizontal form-bordered" novalidate="novalidate" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-2 pull-right control-label rtl" for="title">H1 :</label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-2 pull-right control-label rtl" for="url">url :</label>
                                    <div class="col-xs-12 col-sm-8 col-md-10 pull-right">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-2 pull-right control-label rtl" for="meta_title"> title :</label>
                                    <div class="col-xs-12 col-sm-8 col-md-10 pull-right">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="meta_description">Meta description:</label>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label class="col-xs-12 col-md-12 col-sm-12 pull-right control-label rtl" for="xImagePath">تصویر:</label>
