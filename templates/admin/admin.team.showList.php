...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> لیست تیم</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl">لیست تیم</h3>
        ...
        <div class="panel-body">
            <div class="pull-right">
                <a href="<?= RELA_DIR ?>admin/?component=team&action=addTeam"
                   class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i>افزودن تیم جدید </a>
            </div>
            <!-- separator -->
                ...
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0" width="100%">
                    ...
                    ?>
                        <tr>
                            ...
                            <td dir="ltr" align="center"><img height="60px" src="<?=RELA_DIR.'statics/team/'. $fields['image'] ?>"/></td>
                            <td>
                                <a href="<?= RELA_DIR ?>admin/?component=team&action=editTeam&id=<?php echo $fields['Team_id']; ?>">ویرایش</a>
                                <a href="<?= RELA_DIR ?>admin/?component=team&action=deleteTeam&id=<?php echo $fields['Team_id']; ?>">حذف</a>
                            </td>
                        </tr>
                    <?
                    }
