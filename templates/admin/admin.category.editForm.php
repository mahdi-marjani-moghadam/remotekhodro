        ...
        <div class="col-xs-12 col-sm-12 col-md-8  center-block">
          <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal form-bordered" autocomplete="off" novalidate="novalidate" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                   <select class="valid" name="parent_id" id="parent_id">
                    <?
                    foreach($list['category_list'] as $category_id => $value)
                    {
                    ?>
                      <option <?php echo $value['Category_id'] == $list['parent_id'] ? 'selected' : '' ?> value="<?=$value['Category_id']?>">
                    <?=$value['export']?>
                      </option>
                    <?
                    }
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="alt_fa">توضیح عکس(فارسی):</label>
                  <div class="col-xs-12 col-sm-8 pull-right">
                    <input type="text" class="form-control" name="alt_fa" id="alt_fa" autocomplete="off"  value="<?=$list['alt_fa']?>" />
                  </div>
                </div>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="alt_en">توضیح عکس(انگلیسی):</label>
                  <div class="col-xs-12 col-sm-8 pull-right">
                    <input type="text" class="form-control" name="alt_en" id="alt_en" autocomplete="off"  value="<?=$list['alt_en']?>" />
                  </div>
                </div>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                <p class="pull-right margin-right">
                 ...
                 <input name="Category_id" type="hidden" id="Category_id" value="<?=$list['Category_id']?>" />
