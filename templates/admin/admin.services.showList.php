...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> لیست </a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl">لیست سرویس</h3>
        ...
        <div class="panel-body">
            ...
            <div class="pull-right">
                <a href="<?= RELA_DIR ?>admin/?component=services&action=addServices"
                   class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i>افزودن  </a>
            </div>
            <!-- separator -->
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= RELA_DIR ?>admin/?component=services&action=deleteServices&id=<?php echo $fields['Services_id']; ?>">حذف</a>
                            </td>
                        </tr>
                    <?
                    }
