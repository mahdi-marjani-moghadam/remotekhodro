...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> افزودن فعالیت ها جدید</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-tablesorter" class="panel panel-warning">
    <div class="panel-heading bg-white">
      <h3 class="panel-title rtl">فرم فعالیت ها</h3>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8  center-block">
          <form name="queue" id="queue" role="form" data-validate="form"  enctype="multipart/form-data" class="form-horizontal form-bordered"  novalidate="novalidate" method="post">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="brief_description_fa">توضیحات مختصر:</label>
                  <div class="col-xs-12 col-sm-8 pull-right">
