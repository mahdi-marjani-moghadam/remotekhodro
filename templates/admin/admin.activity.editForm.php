...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> ویرایش فعالیت ها</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-tablesorter" class="panel panel-warning">
    <div class="panel-heading bg-white">
      <h3 class="panel-title rtl">جزییات فعالیت ها</h3>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                   <input type="file" name="image">
                    <img class="img-thumbnail" src="<?=RELA_DIR?>statics/activity/<?=$list['image']?>">
                  </div>
                </div>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-6">
              ...
              <div class="col-md-12">
                <p class="pull-right">
                  <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                    ...
                    <input name="Activity_id" type="hidden" id="" value="<?=$list['Activity_id']?>" />
