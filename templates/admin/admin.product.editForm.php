              ...
              <div class="col-xs-12 col-sm-12 col-md-6">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 pull-right">
                            <input type="text" class="form-control" name="video" id="video"  value="<?=$list['video']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 pull-right">
                   <input  class="form-control" type="file" name="image">
                    <img class="img-thumbnail" src="<?=RELA_DIR?>statics/product/<?=$list['image']?>">
                  </div>
                </div>
              </div>
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 pull-right">
                            ...
                            <img class="img-thumbnail" src="<?=RELA_DIR?>statics/product/<?=$list['image2']?>">
                        </div>
                    </div>
                </div>
              ...
              <div class="col-md-12">
                <p class="pull-right">
                  <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                    ...
                    <input name="Product_id" type="hidden" id="" value="<?=$list['Product_id']?>" />
