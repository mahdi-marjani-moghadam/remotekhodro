                        ...
                        <article class="portfolio-item pf-media pf-icons">
                            <div class="portfolio-image">
                                ...
                                <div class="portfolio-overlay">
                                    ...
                                    <a href="<?=RELA_DIR?>services/<?=$v['category_id']?>/<?=$v['Services_id']?>/<?=$v['url']?>" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                                </div>
                            </div>
                            <div class="portfolio-desc">
                                <h3><a href="<?=RELA_DIR?>services/<?=$v['category_id']?>/<?=$v['Services_id']?>/<?=$v['url']?>"><?=$v['title']?></a></h3>
